    ...
    <div className="min-h-screen bg-[#F5F5DC] text-[#3D5A3D] selection:bg-[#9D4A4A] selection:text-white font-sans overflow-x-hidden">
      <main className="max-w-[1600px] mx-auto border-x border-[#3D5A3D]">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 border-b border-[#3D5A3D]">
              ...
              <div className="flex gap-8">
                {['About', 'Visit', 'Blog', 'Contact'].map(item => (
                  <Link 
                    ...
                    className={`text-[10px] font-bold tracking-widest uppercase transition-colors ${item === 'About' ? 'text-[#9D4A4A]' : 'hover:text-[#9D4A4A]'}`}
                  >
                    {item}
                  </Link>
                ))}
          ...
          <div className="md:col-span-4 bg-[#3D5A3D] p-8 flex flex-col items-center justify-center text-white text-center relative overflow-hidden group">
            <div className="relative z-10 animate-spin-slow opacity-20">
              <Star size={160} strokeWidth={1} fill="currentColor" />
            </div>
            <div className="absolute inset-0 flex flex-col items-center justify-center p-12">
              <p className="text-[10px] font-black tracking-[0.3em] uppercase mb-4 text-[#9D4A4A]">Our Purpose</p>
        ...
        {/* MISSION BLOCKS */}
        <section className="grid grid-cols-1 md:grid-cols-12 border-b border-[#3D5A3D]">
          <div className="md:col-span-4 p-12 border-r border-[#3D5A3D] bg-[#9D4A4A] text-white">
          ...
          <div className="md:col-span-8 p-12 md:p-24 bg-white flex items-center">
            <div className="max-w-2xl">
              <p className="text-[10px] font-black tracking-[0.3em] uppercase text-[#9D4A4A] mb-8">The Vision</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 pt-12 border-t border-[#3D5A3D]/10">
                <div>
                  <p className="text-[10px] font-black tracking-[0.2em] uppercase mb-4 text-[#3D5A3D]">Incubation</p>
                ...
                <div>
                  <p className="text-[10px] font-black tracking-[0.2em] uppercase mb-4 text-[#3D5A3D]">Activation</p>
        ...
        {/* IMAGE BLOCK */}
        <section className="border-b border-[#3D5A3D] bg-white overflow-hidden aspect-[21/9]">
          <img 
        ...
        {/* TEAM / VENDORS BLOCK */}
        <section className="grid grid-cols-1 md:grid-cols-12 border-b border-[#3D5A3D]">
          <div className="md:col-span-6 p-12 md:p-24 border-r border-[#3D5A3D] bg-white">
            <Users size={32} className="text-[#9D4A4A] mb-8" />
          ...
          <div className="md:col-span-6 p-12 md:p-24 bg-[#F5F5DC]">
            <MapPin size={32} className="text-[#9D4A4A] mb-8" />
            <h3 className="font-editorial text-5xl italic mb-8 leading-tight text-[#3D5A3D]">The Location</h3>
            <p className="text-lg text-[#666] leading-relaxed mb-12">
