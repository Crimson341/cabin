      ...
      */}
      <main className="max-w-[1600px] mx-auto border-x border-[#3D5A3D]">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12">
          {isLoading ? (
            <div className="md:col-span-12 p-12 md:p-24 text-center border-b border-[#3D5A3D] bg-white">
              <div className="animate-pulse space-y-4">
                <div className="h-8 bg-[#3D5A3D]/10 rounded w-48 mx-auto" />
                <div className="h-4 bg-[#3D5A3D]/10 rounded w-64 mx-auto" />
              </div>
            </div>
          ) : (
          ...
          <div className="md:col-span-4 border-b border-[#3D5A3D] bg-[#F5F5DC] p-6 md:p-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-6 md:mt-8 text-xs text-[#3D5A3D]/40 font-bold tracking-widest uppercase">Newsletter coming soon</p>
          </div>
        </section>
          ...
          <div className="md:col-span-8 p-6 md:p-12 lg:p-24 border-r border-white/10">
            ...
            <div className="flex flex-wrap gap-6 md:gap-8 opacity-50">
              {['Instagram', 'Facebook', 'Twitter', 'Pinterest'].map(social => (
                <span key={social} className="text-xs md:text-[10px] font-black tracking-[0.3em] uppercase">{social}</span>
              ))}
            </div>
          </div>
